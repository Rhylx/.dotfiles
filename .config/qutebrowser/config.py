...
config.bind(',r42', 'set downloads.location.directory ~/Repos/rendu_42 ;; hint links download')
config.bind(',re', 'set downloads.location.directory ~/Repos/Reports ;; hint links download')
config.bind(',rr', 'set downloads.location.directory ~/Repos ;; hint links download')
config.bind(',sd', 'set downloads.location.directory ~/.stardict/dic ;; hint links download')
config.bind(',ss', 'set downloads.location.directory ~/.scripts ;; hint links download')
config.bind(',vb', 'set downloads.location.directory ~/.vim/bundle ;; hint links download')
