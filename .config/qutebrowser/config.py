...
##c.content.user_stylesheets = ["~/Repos/solarized-everything-css/css/solarized-dark/solarized-dark-duckduckgo.com.css"]
...
c.url.start_pages = ['https://github.com/Rhylx']
...
# config.bind('hh', 'set-cmd-text -s :bind')
